...
#
package ProcessMaker::PMIO::ApiFactory;
...
usesub ProcessMaker::PMIO::Object;

use ProcessMaker::PMIO::ApiClient;

=head1 Name

	ProcessMaker::PMIO::ApiFactory - constructs APIs to retrieve ProcessMaker::PMIO objects
...
=head1 Synopsis
	...
	my $api_factory = ProcessMaker::PMIO::ApiFactory->new( ... ); # any args for ApiClient constructor
							  
	# later...
	my $pet_api = $api_factory->get_api('Pet');  
	
	# $pet_api isa ProcessMaker::PMIO::PetApi
...
my %_apis = map { $_ =~ /^ProcessMaker::PMIO::(.*)$/; $1 => $_ } 
			grep {$_ =~ /Api$/} 
			usesub 'ProcessMaker::PMIO';
...
sub new {
    my ($class, %p) = (shift, @_);
	$p{api_client} = ProcessMaker::PMIO::ApiClient->instance(%p);			
