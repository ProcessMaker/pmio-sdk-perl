...
#
package ProcessMaker::PMIO::Object::TaskInstanceAttributes;
...
__PACKAGE__->method_documentation({
    ...
    'instance_overdue_percentage' => {
    	datatype => 'double',
    	base_name => 'instance_overdue_percentage',
    	description => '',
    	format => '',
    	read_only => '',
    		},
