...
#
package ProcessMaker::PMIO::Role;
use utf8;
...
use Class::Inspector;
use Log::Any qw($log);
use ProcessMaker::PMIO::ApiFactory;
...
has api_factory => ( is => 'ro',
                     isa => 'ProcessMaker::PMIO::ApiFactory',
                     builder => '_build_af', 
                     lazy => 1,
...
has _cfg => ( is => 'ro',
              isa => 'Str',
              default => 'ProcessMaker::PMIO::Configuration',
              );

has version_info => ( is => 'ro', 
                      isa => 'HashRef', 
                      default => sub { {
                          app_name => 'ProcessMaker API',
                          app_version => '1.0.0',
                          generated_date => '2017-06-01T10:49:16.404+03:00',
...
sub _build_af {
	...
	return ProcessMaker::PMIO::ApiFactory->new(%args);
}
...
=head2 ProcessMaker API version: 1.0.0
...
=item Build date: 2017-06-01T10:49:16.404+03:00
...
The tokens will be placed in the C<ProcessMaker::PMIO::Configuration> namespace
as follows, but you don't need to know about this. 

=over 4

=item C<$ProcessMaker::PMIO::Configuration::username>

String. The username for basic auth.

=item C<$ProcessMaker::PMIO::Configuration::password>

String. The password for basic auth.

=item C<$ProcessMaker::PMIO::Configuration::api_key>
...
=item C<$ProcessMaker::PMIO::Configuration::api_key_prefix>
...
=item C<$ProcessMaker::PMIO::Configuration::access_token>
